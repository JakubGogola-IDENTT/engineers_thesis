...
\newenvironment{customalgorithm}[1][htb]
  {\renewcommand{\algorithm}{Pseudokod}% Update algorithm name
   \begin{algorithm}[1]%
  }{\end{algorithm}}
...
% Środowisko do hipotez
\newtheorem{hypothesis}{Hipoteza}[chapter]
...
% dane promotora
				\put(200,60){\makebox(0,0)[l]{\large dr. inż. Piotra Sygi}}
